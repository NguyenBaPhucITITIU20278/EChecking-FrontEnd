...
const DashboardLecturer = () => {
    return (
        <><div>DashboardLecturer</div><div className='text-black' style={{ 
            ...
            <div className="relative z-10 flex justify-center items-center h-screen">
                <button className="dashboard-button transform transition duration-300 hover:scale-105" onClick={() => console.log('Student List button clicked')}>
                    <div className="border-2 border-gray-400 relative w-1444 h-1024 bg-white shadow-lg p-8 mr-8 mt-10 mt-50 rounded-2xl">
                        ...
                        <h1 className="pl-10 text-2xl font-semibold mt-32 mr-20 ml-10 text-gray-700">Student List</h1>
                    </div>
                </button>
                <button className="dashboard-button transform transition duration-300 hover:scale-105" onClick={() => console.log('Check Attendance button clicked')}>
                    <div className="border-2 border-gray-400 relative w-1444 h-1024 bg-white shadow-lg p-8 mr-8 mt-10 mt-50 rounded-2xl">
                        ...
                        <h1 className="text-2xl font-semibold mt-32 ml-11 mr-11 text-gray-700">Check attendance</h1>
                    </div>
                </button>
                <button className="dashboard-button transform transition duration-300 hover:scale-105" onClick={() => console.log('Setting button clicked')}>
