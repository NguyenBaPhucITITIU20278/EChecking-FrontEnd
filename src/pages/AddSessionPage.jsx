                    ...
                    <div className='space-y-2 h-full'>
                        ...
                        <div className="flex justify-center gap-3 pt-3">
                            <button
                                ...
                                className='sm:block hidden bg-gray-400 hover:bg-gray-600 text-white font-montserrat w-1/2 h-10 tracking-wider rounded-sm items-center transform shadow cursor-pointer'>
                            ...
                            <button
                                ...
                                type="button" className="bg-blue-500 hover:bg-blue-600 text-white font-montserrat  w-1/2 h-10 tracking-wider rounded-sm items-center transform shadow cursor-pointer">
